...
//
//  LOOPIT32.C - This is a demo program using the 32-bit TMEX DLL
//               'IBFS32.DLL' to loop and display the ROM number of the 
...
void main(int argc, char **argv)
{
   ...
   if (!LoadTMEX())
   {
      printf("ERROR, could not load IBFS32.DLL   %d\n",hInst);
      exit(0);
   }
...
short LoadTMEX(void)
{
   ...
   if (hInst != NULL)
   {
      ...
      TMExtendedStartSession = (long (far pascal *)(short,short,void far *))ExtendedStartSession;
      return 1;
   }
   else
      return 0;
